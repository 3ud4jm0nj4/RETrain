...
typedef struct _IMAGE_DOS_HEADER {
    ...
    DWORD e_lfanew;     /* 3c: Offset to extended header */  //trỏ tới HEader 
...
typedef struct _IMAGE_FILE_HEADER {
  WORD  Machine;        //thông số máy, xem mã trên PE format của mỉcrosoft
  WORD  NumberOfSections; // số section
  DWORD TimeDateStamp;  //ngày phần mềm được compile đổi sang int rồi sang Unix timestamp
  DWORD PointerToSymbolTable;
  DWORD NumberOfSymbols;
  WORD  SizeOfOptionalHeader;   //thường là 224byte
  WORD  Characteristics;        //đặc điểm của file, giá trị này bằng tổng các đặc điểm của file 
...
typedef struct _IMAGE_OPTIONAL_HEADER {
  ...
  WORD  Magic; /* 0x10b or 0x107 */	/* 0x00 */ //để xác định xem là 32bit(10B) hay 64 bit (20B) 
  BYTE  MajorLinkerVersion;
  BYTE  MinorLinkerVersion;
  DWORD SizeOfCode;
  DWORD SizeOfInitializedData;   //giá trị data khởi tạo 
  DWORD SizeOfUninitializedData;
  DWORD AddressOfEntryPoint;		/* 0x10 */ //địa chỉ thực hiện câu lệnh đầu tiên
  DWORD BaseOfCode;
  DWORD BaseOfData;
  ...
  DWORD Win32VersionValue;
  DWORD SizeOfImage;
  DWORD SizeOfHeaders;  //kích thước của tất cả header dos header, section headers,..
  DWORD CheckSum;			/* 0x40 */
  WORD  Subsystem;
  WORD  DllCharacteristics;
